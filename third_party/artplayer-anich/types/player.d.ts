...
export declare class Player {
  ...
  /**
   * Anich Edition: synchronously dispose the currently-active
   * `customType` handler (e.g. an attached Hls.js instance). Called
   * automatically by ArtPlayer on source switch and on `destroy()`,
   * but exposed so host apps can also trigger it manually (e.g.
   * before swapping in a fresh Hls.js on quality change).
   */
  runCustomTypeDispose(): void
