...
export interface Option {
   ...
   * fullscreen/fullscreenWeb/pip/airplay/fastForward) so host apps
   * can supply their own `controls` array on a blank slate.
   */
  blankSlate?: boolean
   ...
   * Bilibili-style CSS overrides take effect (danmaku-first layout,
   * rose progress bar, glassy semi-transparent control bar).
   */
  anichTheme?: boolean
