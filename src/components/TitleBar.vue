...
<template>
  <!-- 标题栏与整体窗口融为一体：透明底、无分隔线、不显示版本号 -->
  <div
    data-tauri-drag-region
    class="flex h-10 shrink-0 select-none items-center justify-between bg-transparent px-3"
  >
    <div data-tauri-drag-region class="flex items-center gap-2.5">
      <img src="/aikf-logo-128.png" alt="AiKF" class="h-5 w-5 rounded-md" draggable="false" />
      <span data-tauri-drag-region class="text-xs font-semibold tracking-tight text-foreground">AiKF</span>
    </div>
